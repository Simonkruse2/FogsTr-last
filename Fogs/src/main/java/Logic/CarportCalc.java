...
public class CarportCalc {
    ...
    /**
     * Calculates the amount of poles needed for a carport. id is the id on the
     * material in the database that is used as poles innerLength is the length
     * of the carport minus 130 cm where 100 cm is the length the roof can
     * protrude in the front of the carport and the last 30 cm is the length
     * that the roof can protrude in the back. mat is a material with the
     * parameters string description, double price amount is initialised as 4
     * cause there is 1 pole in each corner. extraamount will either remain 0 or
     * it will be redefined as the innerLength divided by 310 cm (a predefined
     * maximum distance allowed between poles). 1 is subtracted from this number
     * since poles are already placed in the front and back. This is multiplied
     * by 2 because the poles needs to be placed in both sides.
     *
     ...
     * carport. the amount is the length of the carport minus 130 cm where 100
     * cm is the length the roof can protrude in the front of the carport and
     * the last 30 cm is the length that the roof can protrude in the back. This
     * is then divided by 310 cm (a predefined maximum distance allowed between
     * poles).
     *
     ...
     * carport. the distance is the length of the carport minus 130 cm where 100
     * cm is the length the roof can protrude in the front of the carport and
     * the last 30 cm is the length that the roof can protrude in the back this
     * is then divided by number of poles (polesDrawing)
     *
     * @param length
    ...
    /**
     * Calculates the amount of beams needed for a carport. id is the id on the
     * material in the database that is used as beams mat is a material with the
     * parameters string description, double price amount is initialised as 2
     * cause there is 2 beams - 1 in each side
     *
     * @param length length of the carport
     * @return a material with a new Description, MaterialPrice, Unit and the
     * new calculated Amount, TotalPrice
    ...
    /**
     * Calculates the amount of rafts needed for a carport. id is the id on the
     * material in the database that is used as rafts mat is a material with the
     * parameters String description, double price amount is calculated by
     * taking the length, divide it by 60 (the maximum distance allowed between
     * each raft) and adding 1 to this because there needs to be 1 raft at each
     * end of the carport
     *
     * @param length length of the carport
    ...
    /**
     * Calculates the distance between rafts for a carport in the drawing of a
     * carport. the distance is the length of the carport divided by amount of
     * rafts (raftDistance)
     *
     * @param length length of the carport
     * @param width width of the carport
     ...
     * id is the id on the material in the database that is used as fittings mat
     * is a material with the parameters String description, double price
     * pamount is defined as number of poles but represents the number of
     ...
     * the fittings mat is a material with the parameters String description,
     * double price amount is defined as 6 (number of screws per fitting) times
    ...
    /**
     * Calculates the amount of frames needed on the sides for a carport. id is
     * the id on the material in the database that is used as frame mat is a
     * material with the parameters String description, double price amount of
     * frames on the side is 2 because there needs to be one on each side
     *
     * @param length length of carport
     * @param width width of carport
     * @return a material with a new Description, MaterialPrice, Unit and the
     ...
     * id is the id on the material in the database that is used as frame mat is
     * a material with the parameters String description, double price amount of
     * frames is 2 because there needs to be 1 in the front and 1 in the back of
     * the carport
     *
     * @param length length of carport
     * @param width width of carport
    ...
    /**
     * Calculates the amount of screws needed for the frame of the carport. id
     * is the id on the material in the database that is used as screws for the
     * frames mat is a material with the parameters string description, double
     * price lamount is initialised as 2 times 2 times the number of rafts
     * because there is 2 screws per raft but also in both sides. wamount is 2
     * times the width divided by 60, 2 represents 2 screws per position and the
     * 60 is the distance between each position
     *
     * @param length length of carport
     * @param width width of carport
     * @return a material with a new Description, MaterialPrice, Unit and the
     ...
     * for the carport. The int carportSqrmtr is multiplied by 0.46, which is
     * the percentage of plastmoLong needed for the roof cover.
     *
     * @param length length of carport
     * @param width width of carport
     * @return a material with a new Description, MaterialPrice, Unit and the
    ...
    /**
     * PlastmoLong calculates the amount of plastmo, plastic roofcover, needed
     * for the carport. The int carportSqrmtr is multiplied by 0.77, which is
     * the percentage of plastmoLong needed for the roof cover.
     *
     * @param length length of carport
     * @param width width of carport
